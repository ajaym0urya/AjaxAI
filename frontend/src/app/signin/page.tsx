...
export default function SignInPage() {
  ...
  const handleSignIn = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Short delay for the user to see the success message before redirecting
      setTimeout(() => {
  ...
  return (
    <main className="min-h-screen flex items-center justify-center p-6 relative overflow-hidden bg-[#0A0A0A]">
      <div className="absolute bottom-[-10%] right-[-10%] w-[500px] h-[500px] rounded-full bg-purple-600/20 blur-[120px] animate-float"></div>
      ...
      <div className="w-full max-w-md z-10 animate-fade-in">
        <div className="text-center mb-8">
          ...
          <p className="text-slate-400">Sign in to manage your automated job hunt.</p>
        </div>

        <form onSubmit={handleSignIn} className="glass rounded-2xl p-8 shadow-2xl border border-white/10 flex flex-col gap-5">
          ...
          <button disabled={loading} type="submit" className="mt-2 w-full bg-purple-600 hover:bg-purple-500 text-white font-bold py-3 rounded-xl transition-all">
